...
bool Element::ArrayPush(Element *value) {
    if (type != Type::Array) {
        return false;
    }
...
bool Element::ObjectPush(Element *key) {
    if (type != Type::Object) {
        return false;
    }
...
bool Element::ValuePush(Element *value) {
    if (type != Type::Key) {
        return false;
    }
...
Element *Element::FindChildElement(const std::string_view &name) {
    if (type != Type::Object) {
        return nullptr;
    }
